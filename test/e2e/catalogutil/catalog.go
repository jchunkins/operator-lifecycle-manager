...
func createCSVTemplate(catalogEntry *CatalogEntry) (*operatorsv1alpha1.ClusterServiceVersion, error) {
	...
	result := operatorsv1alpha1.ClusterServiceVersion{
										...
										Containers: []corev1.Container{
											{
												...
												Env: []corev1.EnvVar{
													...
													{
														Name:  "RELATED_IMAGE_NGINX",                                                                                     // TODO
														Value: "cp.icr.io/cp/open-content-nginx@sha256:7ac7819e1523911399b798309025935a9968b277d86d50e5255465d6592c0266", // TODO
													},
												},
		...
		// TODO: relatedImages is not in this struct...
	}
	return &result, nil
}
